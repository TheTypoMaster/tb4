<?php
/*
 *  Accept bets from the TopBetta Laravel application and place them with configured service provider 
 *  
 *    
 */

class WageringApiDriver extends WageringApi
{
	...
	private function _getAccountService(){
		return new WageringServiceIgas();
	}
