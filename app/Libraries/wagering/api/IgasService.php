<?php
/*
 * Name: iGAS Service API class
 * Provides: SERVICE: Direct interface to 3rd Party API
 * 
 * Comments: Provides the interface to place bets via a 3rd party directly.
 * 
 * Written By: Oliver Shanahan
 * Date: May 2013
 * 
 */


class WageringApiIGAS {
	...
	*/
	final public function __construct()
	{
		...
		// - URL/Username/Password/Token etc
		
		
		// call the initalise method if it exists	
	...
	*/
	...
	/* 
	 * check connection to provider is available
	 */
