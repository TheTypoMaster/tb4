			...
			<div class="panel panel-info">
				...
				<div class="panel-body">
					<div class="form-group">
						{{ Form::model($betLimit, array('method' => 'PATCH', 'route' => array('admin.settings.update', 'bet_limit'))) }}
					...
					<div class="form-group">
						{{ Form::model($flexiLimit, array('method' => 'PATCH', 'route' => array('admin.settings.update', 'bet_flexi'))) }}
