...
class SelectionPricesService {
    ...
    public function overridePrice($selectionId, $productCode, $amount, $betType, $manual = false)
    {
        ...
        \Bus::dispatch(new PriceSocketUpdate(array("id" => $selection->market->event->id, "product" => $product->id, "selections" => array(array("id" => $selection->id, "prices" => (new PriceResource($price))->toArray())))));
