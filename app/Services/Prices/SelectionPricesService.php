...
class SelectionPricesService {
    ...
    public function overridePrice($selectionId, $productCode, $amount, $betType, $manual = false)
    {
        ...
        \Bus::dispatch(new PriceSocketUpdate(array("id" => $selection->market->event->id, "product" => $productCode, "selections" => array("id" => $selection->id, "prices" => (new PriceResource($price))->toArray()))));
