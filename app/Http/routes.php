...
Route::group(array('prefix' => 'admin', 'before' => 'auth.admin', 'after' => 'topbetta_secure_links'), function() {
    ...
    Route::get('tournament-comments/{tournament_id}/{username}/{visibility}', 'Admin\TournamentCommentsController@index');
    Route::post('tournament-comments/{tournament_id}/{username}/{visibility}', 'Admin\TournamentCommentsController@index');
