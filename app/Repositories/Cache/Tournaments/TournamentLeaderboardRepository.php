...
class TournamentLeaderboardRepository extends CachedResourceRepository implements TournamentLeaderboardRepositoryInterface
{
    ...
    public function addToCollection($resource, $collectionKey, $resourceClass = null)
    {
        ...
        \Log::debug("TournamentLeaderboardRepository(addToCollection): Putting tournament {$resource->tournament_id} leaderboard in cache for " . $this->getCollectionCacheTime(self::COLLECTION_TOURNAMENT_LEADERBOARD, $resource));
