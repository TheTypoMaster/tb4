...
<div class="resetForm">
	<div class="resetFormInr">
		...
		<form action="<?php echo JRoute::_( 'index.php?option=com_topbetta_user&task=remindusername' ); ?>" method="post">
			<div class="desc"><?php echo JText::_('REMIND_USERNAME_DESCRIPTION'); ?></div>
			<div class="frm">
