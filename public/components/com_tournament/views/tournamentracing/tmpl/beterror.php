  ...
  <div id="bettixPopWrap">
    <div class="bettixPanel">
      <div class="bettixHead">
        <div class="bettixHeadTitle">Bet Confirmation - <?php print $this->tournament_name; ?></div>
        <div class="bettixHeadRace">Race <?php print $this->race_number; ?> - <?php print $this->race_name; ?></div>
      </div>
