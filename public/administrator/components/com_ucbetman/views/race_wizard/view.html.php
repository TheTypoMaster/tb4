...
class race_wizardViewrace_wizard extends JView
{
	/**
	 * Custom Constructor
	 */
    ...
    global $mainframe, $context;
		...
		$document->setTitle( JText::_('TopBetta Administration - Create / Edit Racing Tournaments ') );
   
   
    //DEVNOTE: Set ToolBar title
    JToolBarHelper::title(   JText::_( 'Create / Edit Racing Tournaments' ), 'generic.png' );
